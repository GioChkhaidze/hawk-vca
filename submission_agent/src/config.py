...
DEFAULT_CAPTION_PROXY_TIMEOUT_SECONDS = 135
DEFAULT_RUN_DEADLINE_SECONDS = 510
DEFAULT_MAX_CLIP_CONCURRENCY = 3
DEFAULT_STORYBOARD_PERCEPTION_ENABLED = False
DEFAULT_STORYBOARD_MAX_FRAMES = 30
...
def load_config(env: Mapping[str, str] | None = None) -> AppConfig:
  ...
  return AppConfig(
    ...
    storyboard_max_frames=min(30, env_int("STORYBOARD_MAX_FRAMES", DEFAULT_STORYBOARD_MAX_FRAMES)),
  )
